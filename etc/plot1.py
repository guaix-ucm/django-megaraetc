...
def plot_and_save_new(tempname, x, y, mu_var, fwhm_var, linef_var, vph_minval_var, vph_maxval_var, label1, label2, label3):
    import matplotlib.pyplot as plt
    ...
    ax.plot([gauxmin,gauxmax], [filty[minxindex],filty[maxxindex]], color='g')  # continuum

    ax.plot([gauxmin, gauxmin], [filty[minxindex], gauy[0]], color='g', ls='--')
    ax.plot([gauxmax, gauxmax], [gauy[numpoints-1], filty[maxxindex]], color='g', ls='--')
