def bokehplot1(x, y,
    ...
    if fluxt == 'L':
        ...
        ("input line" , [p1.line(line_dash='dashed', line_width=1, color='green')]),
        ('', []),
        ('Source: ' + str(label1), []),
        ('Cont. mag: ' + str(label2), []),
    ...
    p2 = figure(plot_height=400,
                x_range=p1.x_range, active_scroll="wheel_zoom", toolbar_location="above")
    ...
    if fluxt=='L':
        legend2 = Legend(items=[
            ("per-fr. c fib.", [p2.line(line_width=1, color='red')]),
            ("all-fr. c fib." , [p2.line(line_width=3, color='red')]),
            ("per-fr. c+r1 fibs." , [p2.line(line_width=1, color='blue')]),
            ("all-fr. c+r1 fibs.", [p2.line(line_width=3, color='blue')]),
            ("", []),
            ("Source: " + str(label2a), []),
            ("VPH: " + str(label2b), []),
